...
import DriverOptions from "../navbar/DriverOptions";
import DriverModal from "../navbar/DriverModal";
import DriverNotification from "../navbar/DriverNotification1";
import DriverPortalPopup from "../navbar/DriverPortalPopup";

interface Props{
  current_tab: string;
}

const DriverHeader = ({current_tab}:Props) => {
    ...
    return (
        ...
        >
          ...
          <div className="flex flex-row items-center justify-start mt-[-1.5rem] mr-[-5%] gap-[16px]">
            ...
            />
            <img
              className="relative w-5 h-5 overflow-hidden shrink-0 cursor-pointer"
              alt=""
        ...
        <div className="absolute top-[50%] left-[2%] flex flex-row items-start mb-20 justify-start gap-[10px]">
          <DriverOptions current_tab={current_tab} />
        </div>
        {isNotificationOpen && (
        <DriverPortalPopup
