  ...
  const saveUser = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8085/api/v1/admins/signup",
        Customer
      );

      console.log(response.data);
      alert("Email verification has been sent for confirmation")
    ...
    <div className=" bg-sky-950">
        ...
        <div className="md:container md:mx-auto px-8 py-20 md:w-8/12 lg:w-5/12">
          <div className="items-center shadow-lg bg-white flex flex-col px-8 rounded-2xl max-md:px-5">
            ...
            <div className="text-violet-700 text-sm leading-5  self-center whitespace-normal mt-5 mb-5 md:flex md:flex-col items-stretch">
