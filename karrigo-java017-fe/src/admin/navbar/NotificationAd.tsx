 ...
 interface NotificationsState {
  ...
  export default class Notifications extends Component<{}, NotificationsState>{
   ...
   render() {
    ...
    return (
    <div className="relative bg-white flex flex-col items-start justify-start p-6 box-border gap-[6px] max-w-[60%] max-h-full    text-left text-sm text-dimgray font-body-text-normal-16 top-[-60%] left-[90%] rounded-2xl">
      ...
      {notifications.map((notification, index) => (
        ...
        <div className="absolute top-[0px] left-[0px] w-[612px] h-[90px]">
         ...
         <div className="absolute top-[16px] left-[60px] flex flex-col items-start justify-start py-0 pr-[40.58123779296875px] pl-0 gap-[4px]">
            <div className="relative leading-[18px] font-semibold flex w-[80%] items-center whitespace-normal" 
