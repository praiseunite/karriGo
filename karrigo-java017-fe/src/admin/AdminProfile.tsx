...
function AdminProfile(props: any) {
        ...
        <div className="flex flex-col items-stretch w-full ml-[10%] mr-[10%] max-md:w-full max-md:ml-0 ">
          ...
          <form className="flex flex-col w-full max-md:max-w-full max-md:mt-6 mt-[2rem]">
            ...
            <div className="flex flex-row gap-[20rem]">
              <button
                type="button"
                className="text-white text-base font-semibold leading-5 tracking-[2px] uppercase whitespace-nowrap justify-center items-center border border-[color:var(--Log-Pri2,#EEE3FF)] bg-violet-700 mt-8 px-4 py-2 rounded-[100px] border-solid max-md:max-w-full max-md:mt-6 mb-8 cursor-pointer"
                onClick={handleSave}
              >
                Save Changes
              </button>
