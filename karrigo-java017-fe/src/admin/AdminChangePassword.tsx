...
function AdminChangePassword(props: any) {
  ...
  return (
    <>
      ...
      <div className="justify-items-center items-center justify-center container h-[50%] w-[50%]  flex flex-col items-stretch rounded-3xl">
        <div className=" ml-5 max-md:w-full max-md:ml-0 bg-grey-100 ">
          <Form
            form={form}
            name="signup"
            scrollToFirstError
